...
ret = solution.naked_twins(before_naked_twins)

print('after_naked_twins\n')
print(json.dumps(after_naked_twins,indent=4,sort_keys=True))
...
for unit in utils.unitlist:
    print(','.join([possible_solutions_1[0][box] for box in unit]))
print('')

print('possible_solutions_1[1]')
for unit in utils.unitlist:
    print(','.join([possible_solutions_1[1][box] for box in unit]))
print('')
